...
@c
@def@utopiaversion{2012-10-04.01.A.R}
@c
@c--------------------------------------------------------------------------------------
@c This file is customized by Andres Raba combining and borrowing from three files: 
@c palatino.tex from GNU Press, texinfo.tex from Free Software Foundation, and
...
\else
  % was 10pt:
  \def\textfontsize{16pt}				% Size of the main roman font.
  \textleading = 21.3pt 				% 33% (Utopia needs more air)
  \setfont\textrm\rmfontprefix\rmshape{\textfontsize}
\fi
...
% For tt shapes:					% Bera Sans Mono is bigger than Utopia,
\setfont\texttt\ttfontprefix\ttshape{14.1pt}		% needs scaling (exact x-height match is 14.4pt,
\setfont\textttsl\ttfontprefix\ttslshape{14.1pt}	% but 14.1pt gives better optical balance)
% For math:
...
% For tt shapes:
\setfont\smalltt\ttfontprefix\ttshape{12.43pt}		% (exact match is 12.6pt)
\setfont\smallttsl\ttfontprefix\ttslshape{12.43pt}
% For math:
