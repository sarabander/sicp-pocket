...
% For tt shapes:
\setfont\texttt\ttfontprefix\ttshape{14.0pt}		% Bera Sans Mono is bigger than Utopia,
\setfont\textttsl\ttfontprefix\ttslshape{14.0pt}	% needs scaling (exact match is 14.4pt)
% For math:
...
% For tt shapes:
\setfont\smalltt\ttfontprefix\ttshape{12.3pt}		% (exact match is 12.6pt)
...
\def\titlefontsize{30pt} % was 26.8pt (34pt)
